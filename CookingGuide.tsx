...
function CookingGuide() {
	return (
		<>
			...
			On each ingredient, there is a difficulty and size rating. <br />Difficulty is how complex a dish is made by
			adding it to the pot, which in turn makes the success rate lower and the time to cook higher. The higher
			your effective level, the more complex dishes one can make. <br />Size on the other hand, is the size of the
			...
			A Ladle, obtained from Goblins in Combat, is a valueable tool. There are few different
